...
function exponential(attempts) {
    var delay = attempts.delay * (attempts.count - attempts.remaining);

    var factor = 2;
    var attempt = (attempts.count - attempts.remaining);
    var random = 1.5;
    var minTimeout = 5000;
